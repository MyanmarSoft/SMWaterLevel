<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Home.Master" AutoEventWireup="true" CodeBehind="editcoaaccount.aspx.cs" Inherits="SMAccount.COAAccounts.editcoaaccount" %>
<%@ Register Src="~/UserControls/Sidebar.ascx" TagPrefix="SOFTWAREMYANMAR" TagName="Sidebar" %>
<asp:Content ID="Content1" ContentPlaceHolderID="title" runat="server">
    Edit COA Account | SMAccount
</asp:Content>
    ...
    <div class="content-wrapper">
        ...
        <small>Modify</small>
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">Edit COA Account</li>
            </ol>
        </section>
                ...
                <div class="col-md-12">
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title">Modify COA Account</h3>
                        </div>
                        <div class="box-body">
