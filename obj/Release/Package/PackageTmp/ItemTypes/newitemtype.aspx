<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Home.Master" AutoEventWireup="true" CodeBehind="newitemtype.aspx.cs" Inherits="SMAccount.ItemTypes.newitemtype" %>
<%@ Register Src="~/UserControls/Sidebar.ascx" TagPrefix="SOFTWAREMYANMAR" TagName="Sidebar" %>
<asp:Content ID="Content1" ContentPlaceHolderID="title" runat="server">
    New Item Type | SMAccount
</asp:Content>
    ...
    <div class="content-wrapper">
        ...
        <small>Create</small>
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">New Item Type</li>
            </ol>
        </section>
