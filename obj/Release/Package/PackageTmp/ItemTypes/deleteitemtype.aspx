<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Home.Master" AutoEventWireup="true" CodeBehind="deleteitemtype.aspx.cs" Inherits="SMAccount.ItemTypes.deleteitemtype" %>
<%@ Register Src="~/UserControls/Sidebar.ascx" TagPrefix="SOFTWAREMYANMAR" TagName="Sidebar" %>
<asp:Content ID="Content1" ContentPlaceHolderID="title" runat="server">
    Delete Item Type | SMAccount
</asp:Content>
    ...
    <div class="content-wrapper">
        ...
        <small>Remove</small>
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">Delete Item Type</li>
            </ol>
        </section>
                ...
                <div class="col-md-12">
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title">Delete Item Type</h3>
                        </div>
                        <div class="box-body">
                        ...
                        <div class="box-footer">
                            ...
                            <asp:LinkButton ID="btnYes" runat="server" CssClass="btn btn-primary btn-flat pull-right" OnClick="btnYes_Click" ><i class="fa fa-save (alias)"></i> Yes</asp:LinkButton>
                        </div>
                    </div>
                </div>
            </div>
