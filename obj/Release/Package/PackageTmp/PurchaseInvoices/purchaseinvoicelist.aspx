<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Home.Master" AutoEventWireup="true" CodeBehind="purchaseinvoicelist.aspx.cs" Inherits="SMAccount.PurchaseInvoices.purchaseinvoicelist" %>
                                ...
                                <asp:Repeater ID="rptInvoiceList" runat="server" OnItemCommand="rptInvoiceList_ItemCommand">
                                    <HeaderTemplate>
                                        <table class="table table-hover table-bordered table-striped">
                                            <tr>
                                                 <th>
                                                    <asp:LinkButton ID="btnPurchaseInvoiceNo" runat="server" CssClass="btn-flat" CommandName="PurchaseInvoiceNo">PurchaseInvoiceNo <i class="fa fa-sort"></i></asp:LinkButton></th>
                                            
                                                 <th>
                                                    <asp:LinkButton ID="btnSupplierName" runat="server" CssClass="btn-flat" CommandName="PatientID">SupplierName <i class="fa fa-sort"></i></asp:LinkButton></th>
                                       
                                                 <th>
                                                     <asp:LinkButton ID="btnPatientName" runat="server" CssClass="btn-flat" CommandName="PatientName">Payment Method <i class="fa fa-sort"></i></asp:LinkButton></th>
                                                <th>
                                                    <asp:LinkButton ID="btnDoctorName" runat="server" CssClass="btn-flat" CommandName="DoctorName">InventoryLocationName <i class="fa fa-sort"></i></asp:LinkButton></th>
                                                <th>
                                                 ...
                                                 <th>
                                                    <asp:LinkButton ID="btnInvoiceDate" runat="server" CssClass="btn-flat" CommandName="InvoiceDate">Purchase Invoice Date <i class="fa fa-sort"></i></asp:LinkButton></th>
                                                <th>
                                    ...
                                    <ItemTemplate>
                                        <tr>
                                            <td>
                                                <%# DataBinder.Eval(Container.DataItem, "PurchaseInvoiceNo")%>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <%# DataBinder.Eval(Container.DataItem, "InventoryLocationName")%>
                                            </td>
                                            <td>
                                                <%# DataBinder.Eval(Container.DataItem, "NetTotal")%>
                                            </td>
                                            <td>
                                                <%# DataBinder.Eval(Container.DataItem, "PurchaseInvoiceDate","{0:dd/MM/yyyy}")%>
                                            </td>
                                            <td>
                                                <%# DataBinder.Eval(Container.DataItem, "Status")%>
                                            </td>
                                            <td>
                                                <a href="editinvoice.aspx?InvoiceNo=<%# (DataBinder.Eval(Container.DataItem, "PurchaseInvoiceNo"))%>" class="btn-sm btn-flat btn-primary"><i class="fa fa-pencil"></i> Edit</a>
                                                <a href="deleteinvoice.aspx?InvoiceNo=<%# (DataBinder.Eval(Container.DataItem, "PurchaseInvoiceNo"))%>" class="btn-sm btn-flat btn-danger"><i class="fa fa-trash"></i> Delete</a>
                                                <a href="viewinvoice.aspx?InvoiceNo=<%# (DataBinder.Eval(Container.DataItem, "PurchaseInvoiceNo"))%>" class="btn-sm btn-flat btn-warning"><i class="fa fa-search"></i> View</a>
                                            </td>
                                        </tr>
                                    </ItemTemplate>
                                    <FooterTemplate>
