<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Home.Master" AutoEventWireup="true" CodeBehind="deletepurchaseinvoice.aspx.cs" Inherits="SMAccount.PurchaseInvoices.deletepurchaseinvoice" %>
<%@ Register Src="~/UserControls/Sidebar.ascx" TagPrefix="SOFTWAREMYANMAR" TagName="Sidebar" %>
<asp:Content ID="Content1" ContentPlaceHolderID="title" runat="server">
    Delete Purchase Invoice | SMAccount
</asp:Content>
    ...
    <div class="content-wrapper">
        ...
        <small>Remove</small>
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">Delete Patient</li>
            </ol>
        </section>
                ...
                <div class="col-md-12">
                    <div class="box box-primary">
                        ...
                        <div class="box-footer">
                            ...
                            <asp:LinkButton ID="btnYes" runat="server" CssClass="btn btn-info pull-right" OnClick="btnYes_Click"><i class="fa fa-save (alias)"></i> Yes</asp:LinkButton>
                        </div>
                    </div>
                </div>
            </div>
