<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Home.Master" AutoEventWireup="true" CodeBehind="newbankaccount.aspx.cs" Inherits="SMAccount.BankAccounts.newbankaccount" %>
<%@ Register Src="~/UserControls/Sidebar.ascx" TagPrefix="SOFTWAREMYANMAR" TagName="Sidebar" %>
<asp:Content ID="Content1" ContentPlaceHolderID="title" runat="server">
    New Bank Account | SMAccount
</asp:Content>
    ...
    <div class="content-wrapper">
        ...
        <small>Create</small>
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="#">Bank Account List</a></li>
                <li class="active">New Bank Account</li>
            </ol>
        </section>
                ...
                <div class="col-md-12">
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title">Create Bank Account</h3>
                        </div>
                        <div class="box-body">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <asp:TextBox ID="txtBankAccountName" runat="server" CssClass="form-control" placeholder="Enter Bank Account Name"></asp:TextBox>
                                    </div> 
                                </div>
                            </div>
                        </div>
