<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Home.Master" AutoEventWireup="true" CodeBehind="deleteinventorytransfer.aspx.cs" Inherits="SMAccount.InventoryTransfers.deleteinventorytransfer" %>
<%@ Register Src="~/UserControls/Sidebar.ascx" TagPrefix="SOFTWAREMYANMAR" TagName="Sidebar" %>
<asp:Content ID="Content1" ContentPlaceHolderID="title" runat="server">
    Delete Invoice | SMAccount
</asp:Content>
