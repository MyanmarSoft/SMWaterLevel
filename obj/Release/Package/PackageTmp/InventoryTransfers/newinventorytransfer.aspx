<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Home.Master" AutoEventWireup="true" CodeBehind="newinventorytransfer.aspx.cs" Inherits="SMAccount.InventoryTransfers.newinventorytransfer" %>

<%@ Register Src="~/UserControls/Sidebar.ascx" TagPrefix="SOFTWAREMYANMAR" TagName="Sidebar" %>
<asp:Content ID="Content1" ContentPlaceHolderID="title" runat="server">
    New Inventory Transfer | SMAccount
</asp:Content>
        ...
        <ContentTemplate>
            <div class="content-wrapper">
                <section class="content-header">
                    <h1>New Inventory Transfer
        <small>Create</small>
                    </h1>
                    <ol class="breadcrumb">
                        <li><a href="default"><i class="fa fa-dashboard"></i>Dashboard</a></li>
                        <li><a href="#">Inventory Transfers</a></li>
                        <li><a href="#">Inventory Transfer List</a></li>
                        <li class="active">New Inventory Transfer</li>
                    </ol>
                </section>
                        ...
                        <div class="col-md-12">
                            <div class="box box-primary">
                                <div class="box-header with-border">
                                    <h3 class="box-title">Create Inventory Transfer</h3>
                                </div>
                                <div class="box-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label>Inventory Transfer No</label>
                                                <asp:TextBox ID="txtInvoiceID" runat="server" CssClass="form-control" Enabled="false"></asp:TextBox>
                                            </div>
                                     
                                        <div class="form-group">
                                                <label>From</label>
                                                <asp:DropDownList ID="ddlFromInventoryLocation" runat="server" CssClass="form-control"  AutoPostBack="true">
                                                </asp:DropDownList>  
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                             ...
                                             <div class="form-group">
                                                <label>To</label>
                                                <asp:DropDownList ID="ddlToInventoryLocation" runat="server" CssClass="form-control"  AutoPostBack="true">
                                                </asp:DropDownList>  
                                            </div>
