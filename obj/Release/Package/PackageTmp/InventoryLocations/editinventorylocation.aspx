<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Home.Master" AutoEventWireup="true" CodeBehind="editinventorylocation.aspx.cs" Inherits="SMAccount.InventoryLocations.editinventorylocation" %>
<%@ Register Src="~/UserControls/Sidebar.ascx" TagPrefix="SOFTWAREMYANMAR" TagName="Sidebar" %>
<asp:Content ID="Content1" ContentPlaceHolderID="title" runat="server">
    Edit Inventory Location | SMAccount
</asp:Content>
...
<asp:Content ID="Content3" ContentPlaceHolderID="body" runat="server">
    ...
    <div class="content-wrapper">
        <section class="content-header">
            <h1>Edit Inventory Location
        <small>Modify</small>
            </h1>
            <ol class="breadcrumb">
                <li><a href="default"><i class="fa fa-dashboard"></i>Dashboard</a></li>
                <li><a href="#">Inventory Locations</a></li>
                <li><a href="#">Inventory Location List</a></li>
                <li class="active">Edit Inventory Location</li>
            </ol>
        </section>
                ...
                <div class="col-md-12">
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title">Modify Inventory Location</h3>
                        </div>
                        <div class="box-body">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <asp:TextBox ID="txtInventoryLocationName" runat="server" CssClass="form-control" placeholder="Enter Inventory Location Name"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                        </div>
