<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="forgotpassword.aspx.cs" Inherits="SMAccount.forgotpassword" %>
...
<head runat="server">
   <meta charset="utf-8" />
    ...
    <title>Forgot Password | SMAccount</title>
    ...
    <form id="form1" runat="server">
        <div class="login-box">
            <div class="login-logo">
                <a href="login.html"><img src="AdminLTE/dist/img/alltimetop_logo.png"/></a>
            </div>
            <!-- /.login-logo -->
