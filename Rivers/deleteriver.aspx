<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Home.Master" AutoEventWireup="true" CodeBehind="deleteriver.aspx.cs" Inherits="SMWaterLevel.Rivers.deleteriver" %>
<%@ Register Src="~/UserControls/Sidebar.ascx" TagPrefix="SOFTWAREMYANMAR" TagName="Sidebar" %>
<asp:Content ID="Content1" ContentPlaceHolderID="title" runat="server">
    Delete River | SMWaterLevel
</asp:Content>
    ...
    <div class="content-wrapper">
        ...
        <small>Remove</small>
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">Delete River</li>
            </ol>
        </section>
                ...
                <div class="col-md-12">
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title">Delete River</h3>
                        </div>
                        <div class="box-body">
