<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Home.Master" AutoEventWireup="true" CodeBehind="customerlist.aspx.cs" Inherits="SMWaterLevel.Customers.customerlist" %>
<%@ Register Src="~/UserControls/Sidebar.ascx" TagPrefix="SOFTWAREMYANMAR" TagName="Sidebar" %>
<%@ Register src="../UserControls/Pager.ascx" tagname="Pager" tagprefix="uc1" %>

<asp:Content ID="Content1" ContentPlaceHolderID="title" runat="server">
    Customer List | SMWaterLevel
</asp:Content>
                                            ...
                                            <tr>
                                                <th>
                                                    <asp:LinkButton ID="btnID" runat="server" CssClass="btn-flat" CommandName="ID">ID <i class="fa fa-sort"></i></asp:LinkButton>
                                                      <th>
                                                    <asp:LinkButton ID="btnImage" runat="server" CssClass="btn-flat" CommandName="ID">Photo <i class="fa fa-sort"></i></asp:LinkButton></th>
                                                </th>   
                                                    <th>
                                    ...
                                    <ItemTemplate>
                                        <tr>
                                            <td>
                                             ...
                                             <td>
                                                <img src="../Upload/<%#DataBinder.Eval(Container.DataItem, "ImagePath")%>" width="50" />
                                            </td>
                                            <td>
