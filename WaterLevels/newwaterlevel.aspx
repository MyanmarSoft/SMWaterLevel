<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Home.Master" AutoEventWireup="true" CodeBehind="newwaterlevel.aspx.cs" Inherits="SMWaterLevel.WaterLevels.newwaterlevel" %>

<%@ Register Src="~/UserControls/Sidebar.ascx" TagPrefix="SOFTWAREMYANMAR" TagName="Sidebar" %>
<asp:Content ID="Content1" ContentPlaceHolderID="title" runat="server">
    New WaterLevel | SMWaterLevel
</asp:Content>
    ...
    <div class="content-wrapper">
        ...
        <small>Create</small>
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">New WaterLevel</li>
            </ol>
        </section>
                ...
                <div class="col-md-12">
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title">Create WaterLevel</h3>
                        </div>
                        <div class="box-body">
