<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Home.Master" AutoEventWireup="true" CodeBehind="editdam.aspx.cs" Inherits="SMWaterLevel.Dams.editdam" %>
<%@ Register Src="~/UserControls/Sidebar.ascx" TagPrefix="SOFTWAREMYANMAR" TagName="Sidebar" %>
<asp:Content ID="Content1" ContentPlaceHolderID="title" runat="server">
    Edit Dam | SMWaterLevel
</asp:Content>
    ...
    <div class="content-wrapper">
        ...
        <small>Modify</small>
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="#">Dams</a></li>
                <li><a href="#">Dam List</a></li>
                <li class="active">Edit Dam</li>
            </ol>
        </section>
                ...
                <div class="col-md-12">
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title">Edit Dam</h3>
                        </div>
                        <div class="box-body">
                             ...
                             <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <asp:TextBox ID="txtDamName" runat="server" CssClass="form-control" placeholder="Enter Dam Name"></asp:TextBox>
                                    </div>
                                    <div class="form-group">
