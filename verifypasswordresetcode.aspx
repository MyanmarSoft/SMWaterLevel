<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="verifypasswordresetcode.aspx.cs" Inherits="SMWaterLevel.verifypasswordresetcode" %>
<!DOCTYPE html>
...
<head runat="server">
   <meta charset="utf-8" />
    ...
    <title>Verify Password Reset Code | SMWaterLevel</title>
    ...
    <form id="form1" runat="server">
        <div class="login-box">
           <div class="login-logo">
                <a href="login.html"><img src="AdminLTE/dist/img/logo.png"/></a>
            </div>
            <!-- /.login-logo -->
            <div class="login-box-body">
                ...
                <div class="form-group has-feedback">
                    <label>We have been sent password reset code</label>
                    <asp:TextBox ID="txtVerifyCode" runat="server" CssClass="form-control" placeholder="Enter Password Reset Code" TextMode="Password"></asp:TextBox>
