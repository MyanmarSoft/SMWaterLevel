<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Home.Master" AutoEventWireup="true" CodeBehind="edituserprofile.aspx.cs" Inherits="SMWaterLevel.UserProfiles.edituserprofile" %>
<%@ Register Src="~/UserControls/Sidebar.ascx" TagPrefix="SOFTWAREMYANMAR" TagName="Sidebar" %>
<asp:Content ID="Content1" ContentPlaceHolderID="title" runat="server">
    Edit User Profile | SMWaterLevel
</asp:Content>
                ...
                <div class="col-md-12">
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title">Modify UserProfile</h3>
                        </div>
                         <div class="box-body">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                     ...
                                     <div class="form-group">
                                        <asp:LinkButton ID="btnChangePassword" runat="server" CssClass="btn btn-default" OnClick="btnChangePassword_Click" ><i class="fa fa-key"></i> Change Password</asp:LinkButton>                      
                                     </div>
                                </div>
                            </div>
                        </div>
