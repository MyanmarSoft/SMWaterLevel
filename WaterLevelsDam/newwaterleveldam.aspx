<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Home.Master" AutoEventWireup="true" CodeBehind="newwaterleveldam.aspx.cs" Inherits="SMWaterLevel.WaterLevelsDam.newwaterleveldam" %>

<%@ Register Src="~/UserControls/Sidebar.ascx" TagPrefix="SOFTWAREMYANMAR" TagName="Sidebar" %>
<asp:Content ID="Content1" ContentPlaceHolderID="title" runat="server">
    New WaterLevel Dam | SMWaterLevel
</asp:Content>
    ...
    <div class="content-wrapper">
        ...
        <small>Create</small>
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">New WaterLevel Dam</li>
            </ol>
        </section>
                ...
                <div class="col-md-12">
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title">Create WaterLevel Dam</h3>
                        </div>
                        <div class="box-body">
