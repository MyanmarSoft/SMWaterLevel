...
namespace SMWaterLevel.Entities
{
	public class MedicalAssessment 
	{
		...
		#region Internal Members
			...
			private	DateTime _MedicalAssessmentDate;
		...
		#region Properties
			...
			public	DateTime  MedicalAssessmentDate
			{
				get 
				{ 
					if(Null.IsNotNull(_MedicalAssessmentDate)) 
					{
					 return _MedicalAssessmentDate;
					}
					else 
					{
					 return DateTime.Now;
				...
				set { _MedicalAssessmentDate = value;}
			}
